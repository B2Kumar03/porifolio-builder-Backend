...
const sendOTP = (email, name, otp) => {
  const mailOptions = {
    ...
    <p>Dear ${name},
    We are excited to have you on board. Your registration is complete, and you can now explore all the features we offer. If you have any questions or need further assistance, feel free to reach out to me.

    </p>
    
    <a href="https://bittu-kumar.netlify.app/">
    <button 
    style="
